                        ...
                        <div class="col-lg-6">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item" style="float: left;"><a href="#!">Daftar Pengabdian Masyarakat</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                  <h5>Daftar Pengabian Masyarakat</h5>
                                </div>
                                <div class="card-block">
                                  <div class="dt-responsive table-responsive">
                                    <table id="order-table" class="table table-striped table-bordered nowrap">
                                      ...
                                      <tbody>
                                        <?php $index = 1; ?>
                                        @foreach ($tbl_pengabdian_masyarakat as $tbl_pengabdian_masyarakat)
                                            <tr>
                                                <td>{{ $index++ }}</td>
                                                <td>{{ $tbl_pengabdian_masyarakat->idpengabdian }}</td>
                                                <td>{{ $tbl_pengabdian_masyarakat->tgl_transaksi }}</td>
                                                <td>{{ $tbl_pengabdian_masyarakat->jumlah }}</td>
                                                <td>
                                                    <i class="ti-pencil text-success edit" style="font-size: 18px" data-id={{ $tbl_pengabdian_masyarakat->idpengabdian }}></i>
                                                    <i class="ti-trash text-danger delete" style="font-size: 18px" data-id={{ $tbl_pengabdian_masyarakat->idpengabdian }}></i>
                                                    <i class="fa fa-shield text-secondary change-password ml-1" style="font-size: 18px; cursor: pointer" data-id={{ $tbl_pengabdian_masyarakat->idpengabdian }}></i>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
...
<div class="modal fade" id="edit-Modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Edit Pengabdian Masyarakat</h4>
          <button type="button" class="close close-btn" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
            ...
            <div class="card">
                <div class="card-block">
                    <form id="edit-form" novalidate>
                        <input type="hidden" name="idpengabdian" id="idpengabdian">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Tanggal Transaksi</label>
                            <div class="col-sm-8">
...
@section('own_js')
    ...
    <script type="text/javascript" src="{{ asset('own_assets/scripts/pages/pengabdian_masyarakat.js') }}"></script>
@endsection
