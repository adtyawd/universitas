                        ...
                        <div class="col-lg-6">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item" style="float: left;"><a href="#!">Daftar Mahasiswa</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-block">
                                  <div class="dt-responsive table-responsive">
                                    <table id="order-table" class="table table-striped table-bordered nowrap">
                                      ...
                                      <tbody>
                                        <?php $index = 1; ?>
                                        @foreach ($tbl_jlh_mahasiswa as $tbl_jlh_mahasiswa)
                                            <tr>
                                                <td>{{ $index++ }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->idmhs }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->tgl_transaksi }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->fakultas }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->jurusan }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->prodi }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->kategori }}</td>
                                                <td>{{ $tbl_jlh_mahasiswa->jumlah }}</td>
                                                <td>
                                                    <i class="ti-pencil text-success edit" style="font-size: 18px" data-id={{ $tbl_jlh_mahasiswa->idmhs }}></i>
                                                    <i class="ti-trash text-danger delete" style="font-size: 18px" data-id={{ $tbl_jlh_mahasiswa->idmhs }}></i>
                                                    <i class="fa fa-shield text-secondary change-password ml-1" style="font-size: 18px; cursor: pointer" data-id={{ $tbl_jlh_mahasiswa->idmhs }}></i>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
...
@section('own_js')
    ...
    <script type="text/javascript" src="{{ asset('own_assets/scripts/pages/jumlah_mahasiswa.js') }}"></script>
@endsection
