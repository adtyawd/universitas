                        ...
                        <div class="col-lg-6">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item" style="float: left;"><a href="#!">Daftar Produk Inovasi</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-block">
                                  <div class="dt-responsive table-responsive">
                                    <table id="order-table" class="table table-striped table-bordered nowrap">
                                      ...
                                      <tbody>
                                        <?php $index = 1; ?>
                                        @foreach ($tbl_produk_inovasi as $tbl_produk_inovasi)
                                            <tr>
                                                <td>{{ $index++ }}</td>
                                                <td>{{ $tbl_produk_inovasi->idproduk }}</td>
                                                <td>{{ $tbl_produk_inovasi->tgl_transaksi }}</td>
                                                <td>{{ $tbl_produk_inovasi->jumlah }}</td>
                                                <td>
                                                    <i class="ti-pencil text-success edit" style="font-size: 18px" data-id={{ $tbl_produk_inovasi->idproduk }}></i>
                                                    <i class="ti-trash text-danger delete" style="font-size: 18px" data-id={{ $tbl_produk_inovasi->idproduk }}></i>
                                                    <i class="fa fa-shield text-secondary change-password ml-1" style="font-size: 18px; cursor: pointer" data-id={{ $tbl_produk_inovasi->idproduk }}></i>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
