...
class TblPengabdianMasyarakatController extends Controller
{
     ...
     */
    public function edit(tbl_pengabdian_masyarakat $tbl_pengabdian_masyarakat)
    {
        //
    }
     ...
     */
    public function update(Request $request, tbl_pengabdian_masyarakat $tbl_pengabdian_masyarakat)
    {
        //
    }
